...
(*   val write_request : 'context Haha.Request.t -> unit *)
...
(*     with type 'context Net_response.t = 'context Haha.Response.t *)
...
(*     type t = Haha.Header.t list *)
(**)
(*     let get s l = Haha.Header.find_opt s l *)
(*   end *)
(**)
(*   module Net_response = struct *)
(*     type 'context t = 'context Haha.Response.t *)
(**)
...
(**)
(*   type 'context client_error = *)
(*     | Unary of *)
(*         ( response, *)
(*           Headers.t, *)
(*           stream_error, *)
(*           connection_error, *)
(*           'context Net_response.t ) *)
